                                      ...
                                      <div class="form-row">
                                        <div class="form-group col-md-6">
                                        	<input type="hidden" name="id" value="{{$m->id}}">
                                          	...
                                          	<input type="text" class="form-control" id="inputEmail4" placeholder="Nama" name="nama" value="{{$m->nama}}" required="">
                                        </div>
                                        <div class="form-group col-md-6">
                                          <label for="inputPassword4">No Identitas</label>
                                          <input type="number" class="form-control" id="inputPassword4" placeholder="No Identitas" name="no_identitas" value="{{$m->no_identitas}}" required="">
                                        </div>
                                      </div>
                                      <div class="form-row">
                                        <div class="form-group col-md-12">
                                          <label for="inputEmail4">Alamat</label>
                                          <textarea  type="text" class="form-control" id="inputEmail4" placeholder="Alamat" name="alamat" required="">{!!$m->alamat!!}</textarea>
                                        </div>
                                      </div>
                                      <div class="form-row">
                                        <center>
