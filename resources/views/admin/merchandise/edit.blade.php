                                    ...
                                    <form>
                                      <div class="form-row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" class="form-control" id="inputEmail4" placeholder="Nama" name="nama" value="{{$merchandise->nama}}" required="">
                                        </div>
                                      <div class="form-row">
                                        <div class="form-group col-md-12">
                                          <label for="inputCity">Deskripsi</label>
                                          <textarea id="ckeditor1" type="text" class="form-control" id="inputCity" name="deskripsi" placeholder="Deskripsi" value="" required="">{!!$merchandise->deskripsi!!}</textarea>
                                        </div>
