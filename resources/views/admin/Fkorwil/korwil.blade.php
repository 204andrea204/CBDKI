                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="login-textarea-area">
                                                <input type="text" class="form-control" cols="30" rows="10" name="nama" required>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="login-textarea-area">
                                                <textarea id="ckeditor1" class="contact-message" cols="30" rows="10" name="keterangan" required ></textarea>
                                      ...
                                      <center>
                                            ...
                                            <br>
                                                <img src="{{asset('images/no-image.png')}}" alt="Nature" class="responsive" id="blah1" style="width: 200px;height: 200px;" required>
                                          <center>
                                            <div class="login-input-head">
                                                <p>Logo</p>
                                            </div>
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <input type="file" id="inputCity" name="logo" onchange="readURL1(this);" required>
                            </div>
                        </div>
                        </center>
                        <center>
