                                      ...
                                      <div class="form-row">
                                        <div class="form-group col-md-6">
                                        	<input type="hidden" name="id" value="{{$korwil2->id}}">
                                          	...
                                          	<input type="text" class="form-control" id="inputEmail4" placeholder="Nama" name="nama" value="{{$korwil2->nama}}" required="">
                                        </div>
                                        <div class="form-group col-md-6">
                                          <label for="inputPassword4">Kode</label>
                                          <input type="number" class="form-control" id="inputPassword4" placeholder="Kode" name="kode" value="{{$korwil2->kode}}" required="">
                                        </div>
                                      </div>
                                      <div class="form-row">
                                        <center>
