                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
                                            ...
                                            <tbody>
                                                <?php
                                                $korwil = \App\Korwilmember::all();
                                                ?>
                                                @foreach ($korwil as $n)
                                                <?php
                                                $i = 1;
                                                $korwil2 = \App\Korwil::where('id',$n->idkorwil)->value('nama');
                                                ?>
                                                <tr>
                                                    <td style="text-align: center;">{{$i++}}</td>
                                                    <td style="text-align: center;">{{$n->nama}}</td>
                                                    <td style="text-align: center;">{{$korwil2}}</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-select">
                                                <select class="form-control" name="idkorwil" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-textarea-area">
                                                <input class="form-control" cols="30" rows="10" name="nama" required="">
                                            </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-textarea-area">
                                                <input class="form-control" cols="30" rows="10" name="kode" required="">
                                            </div>
                                    </div>
                                      <center>
                                    <div class="form-row">
