                                      ...
                                      <div class="row">
                                        <div class="form-group col-md-12">
                                        	<input type="hidden" name="id" value="{{$gallery2->id}}">
                                          	...
                                          	<textarea id="ckeditor1" type="text" class="form-control" id="inputEmail4" placeholder="Pengantar 1" name="pengantar1" value="" required="">{{$gallery2->pengantar1}}</textarea>
                                        </div>
                                        <div class="form-group col-md-12">
                                          <label for="inputPassword4">Pengantar 2</label>
                                          <textarea id="ckeditor2" type="text" class="form-control" id="inputPassword4" placeholder="Pengantar 2" name="pengantar2" value="" required="">{{$gallery2->pengantar2}}</textarea>
                                        </div>
                                      </div>
                                      <div class="form-row">
                                        <center>
