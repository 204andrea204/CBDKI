                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                          <input type="hidden" name="id" value="{{$b->id}}">
                                            ...
                                            <input type="text" class="form-control" id="inputEmail4" placeholder="Judul" name="judul" value="{{$b->judul}}" required="">
                                        </div>
                                      <div class="form-row">
                                        <div class="form-group col-md-12">
                                          <label for="inputCity">Isi</label>
                                          <textarea id="ckeditor1" type="text" class="form-control" id="inputCity" name="isi" placeholder="Isi" value="" required="">{{$b->isi}}</textarea>
                                        </div>
                                      </div>
                                      <div class="form-row">
                                        <center>
