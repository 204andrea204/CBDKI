...
?>
  ...
  <!-- Favicons -->
  <link href="{{asset('https://cbdki.net/cbi_user/img/CBI.png')}}" rel="icon">
    ...
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="#intro" class="scrollto">
          <img src="{{asset('cbi_user/img/CBI.png')}}"></a>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 footer-contact">
            <h4>Berlangganan</h4>
             <form action="{{url('admin/newsletter/save')}}" method="POST" class="form-inline">
                 @csrf
                  <input type="email" class="form-control" placeholder="Masukkan Email" name="email" style="border-radius: 50px; font-size: 14px; width: 70%;">
                  &nbsp;
          ...
          <div class="col-lg-3 col-md-3 footer-contact">
            ...
            <div class="col-lg-3">
              <img src="{{ asset('/cbi_user/img/CBI.png')}}" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
