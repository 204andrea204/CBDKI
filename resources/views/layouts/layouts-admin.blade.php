                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="{{url('/admin')}}"><i class="fa fa-tachometer-alt"></i>
                            <span class="mini-dn">Menu Utama</span> <span class="indicator-right-menu"></span></a>
                        </li>

                        <li class="nav-item">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Profil CBI</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="{{url('/admin/profile')}}" class="dropdown-item"><i class="fa fa-user"></i>&nbsp;Profil</a>
                                <a href="{{url('/admin/about')}}" class="dropdown-item"><i class="fa fa-globe"></i>&nbsp;Tentang</a>
                                ...
                                <a href="{{url('/admin/history')}}" class="dropdown-item"><i class="fa fa-history"></i>&nbsp;Riwayat</a>
                            </div>
                        </li>

                        <li class="nav-item">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Galeri</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="{{url('admin/gallery2')}}" class="dropdown-item"><i class="fa fa-image"></i>&nbsp;Galeri</a>
                                <a href="{{url('/admin/gallery')}}" class="dropdown-item"><i class="fab fa-gg-circle"></i>&nbsp;Multimedia</a>
                            </div>
                        </li>

                        <li class="nav-item">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Pesan</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="{{url('admin/newsletter')}}" class="dropdown-item"><i class="fa fa-envelope-square"></i> Langganan</a>
                                <a href="{{url('/admin/contact')}}" class="dropdown-item"><i class="fa fa-comments"></i>Kontak</a>
                            </div>
                        </li>
                         <li class="nav-item"><a href="{{url('/admin/member')}}"><i class="fa fa-users"></i>
                            <span class="mini-dn">Anggota</span> <span class="indicator-right-menu"></span></a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                ...
                                <a href="{{url('/admin/korwil2')}}" class="dropdown-item"><i class="fa fa-user-shield"></i>&nbsp;Anggota Korwil</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item"><a href="{{url('/admin/merchandise')}}"><i class="fa fa-shopping-bag"></i>
                            <span class="mini-dn">Cendera Mata</span> <span class="indicator-right-menu"></span></a>
                        </li>
                        ...
                        <li class="nav-item"><a href="{{url('/admin/user')}}"><i class="fa fa-user-plus"></i>
                            <span class="mini-dn">Pengguna</span> <span class="indicator-right-menu"></span></a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <li class="nav-item"><a href="{{url('gallery')}}"><i class="fa fa-image"></i>
                            <span class="mini-dn">Galeri</span> <span class="indicator-right-menu"></span></a>
                        </li>
                        <li class="nav-item"><a href="{{url('gallery2')}}"><i class="fa fa-image"></i>
                            <span class="mini-dn">Galeri2</span> <span class="indicator-right-menu"></span></a>
                        </li>
                         ...
                         <li class="nav-item"><a href="{{url('newsletter')}}"><i class="fa fa-envelope-square"></i>
                            <span class="mini-dn">Langganan</span> <span class="indicator-right-menu"></span></a>
                        </li>
                        <li class="nav-item"><a href="{{url('korwil')}}"><i class="fa fa-road"></i>
                         ...
                         <li class="nav-item"><a href="{{url('footer')}}"><i class="fa fa-font"></i>
                          ...
                          <li class="nav-item"><a href="{{url('about')}}"><i class="fa fa-adn"></i>
                            <span class="mini-dn">Tentang</span> <span class="indicator-right-menu"></span></a>
                        </li>
